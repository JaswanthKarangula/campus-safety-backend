DB_URL=postgresql://root:secret@localhost:5432/dronesaefty-backend?sslmode=disable
...
createdb:
	docker exec -it postgres createdb --username=root --owner=root dronesaefty-backend

dropdb:
	docker exec -it postgres dropdb dronesaefty-backend
